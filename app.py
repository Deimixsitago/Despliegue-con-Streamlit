# -*- coding: utf-8 -*-
"""7 Despliegue-Videojuegos con streamlit.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/1s_7LlQRtD7i-mwY6XyynrhpoCfPPQ4Zr
...
*   Aplicamos el modleo para la predicci+on
"""
...
#Y_pred = modelo.predict(data_preparada) FALTAN DUMMIES QUE NO ESTÁN EN ESTOS NUEVOS DATOS
...
#data_preparada[['Edad']]= min_max_scaler.transform(data_preparada[['Edad']]) # estoy usando arbol
data_preparada.head()
...
st.warning("El modelo tiene un error del 3%")